...
<body>
    ...
    <div class="flex flex-col justify-center items-center border-2">
        <div class="flex flex-col items-start justify-start px-12 border-2 border-dashed my-4 py-6 gap-4">
        ...
        <div
            ...
            <div class="flex justify-between items-center w-full border-dashed border-y px-12 py-4">
                <div class="flex justify-between items-center gap-12">
                    <a href="{{ route('products.show', $product->id) }}"><img class="h-28 w-28 object-cover"
        ...
        <div class="flex flex-col border-2 px-8 border-slate-100 py-4 gap-8 ">
