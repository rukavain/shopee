    ...
    <div class="flex border border-2 p-3 rounded-md my-4">
        <div>
            ...
            <div class="flex flex-col h-96 my-4">
                <div class="">
                    <h1 class="font-semibold mb-4">Shipped From</h1>
                </div>
                <div class="flex flex-col gap-4">
                    <div>
                        <input type="checkbox" id="mouse" name="vehicle1" value="Bike">
                        <label for="vehicle1"> Domestic</label><br>
                    </div>
                    <div>
                        <input type="checkbox" id="vehicle2" name="vehicle2" value="Car">
                        <label for="vehicle2"> Overseas</label><br>
                    </div>
                    <div>
                        <input type="checkbox" id="vehicle2" name="vehicle2" value="Car">
                        <label for="vehicle2"> Metro Manila </label><br>
                    </div>
                    <div>
                        <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat">
                        <label for="vehicle3"> North Luzon</label><br><br>
                    </div>
                </div>
